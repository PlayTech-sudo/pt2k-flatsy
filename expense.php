...
border: 3px solid green;background-color: #4CAF50;color:#f2f2f2;font-size:17px;"formaction="addexpense.php">Add expense Information</button>
<!--
...
$var=mysqli_query($con,"select e.expense_id,e.fleet_id,e.maintainance,e.charge,e.status from expense e ");
